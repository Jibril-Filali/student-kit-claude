...
3. Lire `tasks/lessons.md` — appliquer toutes les leçons
4. Mettre à jour `session-log.md` avec la date et l'état au démarrage
5. Si les fichiers n'existent pas, les créer avant de commencer
...
## PROJET
<!-- Decris ce que fait ce projet en 1-2 phrases -->
Stack principale : Java, MySQL, MongoDB
...
## SÉCURITÉ
- Clés API et mots de passe → variables d'environnement uniquement, jamais dans le code
- Faille détectée → signaler en priorité absolue avant tout le reste
